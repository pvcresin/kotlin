...
class ReplaceProtectedToPublishedApiCallFix(
    ...
    override fun getText() = "Create and replace with @PublishedApi bridge call '$newFunctionName(...)'"
    ...
    companion object : KotlinSingleIntentionActionFactory() {
        ...
        override fun createAction(diagnostic: Diagnostic): IntentionAction? {
            ...
            val source = (classDescriptor.source as? KotlinSourceElement)?.psi as? KtClass ?: return null
